...
//
    ...
    {
        wmsStockInEntry.setUpdateBy(SecurityUtils.getUsername());
        wmsStockInEntry.setStockInOperatorId(SecurityUtils.getUserId());
    ...
    {
        return toAjax(wmsStockInEntryService.complete(id,SecurityUtils.getUsername()));
    }
